...
Cogapp mains a free-to-use editor for Storiiies at [storiiies-editor.cogapp.com](https://storiiies-editor.cogapp.com/). To use a compatible v3 manifest for your story, append the shortcode from the "view and share" link to a base URL of `https://manifest.storiiies-editor.cogapp.com/v3/`
